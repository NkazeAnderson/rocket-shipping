...
`
    ...
    case "shipment action":
      return {
        subject: "Shipment Action Required!",
        html: `
             <html>
    <head>
      <title>Complete this action for shipment to proceed</title>
      <meta name="viewport" content="width=device-width, initial-scale=1">
    </head>
    <body style="margin: 0; padding: 0; background-color: #2f2f2f; font-family: Arial, sans-serif;">
      ...
      <div style="max-width: 600px; width: 90%; margin: 20px auto; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
        ...
        <!-- Header -->
        <div style="background-color: #ff7f00; padding: 20px; text-align: center;">
          <h2 style="color: #ffffff; margin: 0; font-size: 24px;">Shipping Action Required!</h2>
        </div>

        <!-- Body -->
        <div style="padding: 20px; color: #888888;">
          <p style="font-size: 16px; margin: 0;">Hello <strong>${requiredInfo.userName}</strong>,</p>
          <p style="font-size: 16px;">There has been an update to your shipment which we can't handle without your action</p>
          <p style="font-size: 16px;">Your delivery agent will contact you in a moment to share details of your shipment status. Please kindly hold on while we gather the information required to get pass this stage of your shipment with ease</p>

          <p style="font-size: 16px;"><strong>Package Details:</strong></p>
          <div style="padding-left: 20px; font-size: 16px;">
            <ul>
                    <li style="margin-bottom: 4px;"><strong>Shipment id:</strong> ${requiredInfo.id}</li>
                    <li style="margin-bottom: 4px;"><strong>Caused By:</strong> ${requiredInfo.cause}</li>
                    <li style="margin-bottom: 4px;"><strong>Product:</strong> ${requiredInfo.product}</li>
                    <li style="margin-bottom: 4px;"><strong>Courrier:</strong> ${requiredInfo.courrier}</li>
